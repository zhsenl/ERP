...
describe Dict::CountriesController do
  ...
  # Dict::Country. As you add validations to Dict::Country, be sure to
  ...
  # Dict::CountriesController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all dict_countries as @dict_countries" do
      country = Dict::Country.create! valid_attributes
      get :index, {}, valid_session
      assigns(:dict_countries).should eq([country])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new country as @country" do
      ...
      assigns(:country).should be_a_new(Dict::Country)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved country as @country" do
        ...
        Dict::Country.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested country" do
        country = Dict::Country.create! valid_attributes
        # Assuming there are no other dict_countries in the database, this
        # specifies that the Dict::Country created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Dict::Country.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the dict_countries list" do
      country = Dict::Country.create! valid_attributes
      delete :destroy, {:id => country.to_param}, valid_session
      response.should redirect_to(dict_countries_url)
    end
  end
