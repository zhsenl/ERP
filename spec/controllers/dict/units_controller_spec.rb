...
describe Dict::UnitsController do
  ...
  # Dict::Unit. As you add validations to Dict::Unit, be sure to
  ...
  # Dict::UnitsController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all dict_units as @dict_units" do
      unit = Dict::Unit.create! valid_attributes
      get :index, {}, valid_session
      assigns(:dict_units).should eq([unit])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new unit as @unit" do
      ...
      assigns(:unit).should be_a_new(Dict::Unit)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved unit as @unit" do
        ...
        Dict::Unit.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested unit" do
        unit = Dict::Unit.create! valid_attributes
        # Assuming there are no other dict_units in the database, this
        # specifies that the Dict::Unit created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Dict::Unit.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the dict_units list" do
      unit = Dict::Unit.create! valid_attributes
      delete :destroy, {:id => unit.to_param}, valid_session
      response.should redirect_to(dict_units_url)
    end
  end
