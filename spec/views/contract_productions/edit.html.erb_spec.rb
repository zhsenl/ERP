...
describe "contract_productions/edit" do
  before(:each) do
  ...
  it "renders the edit contract_production form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => contract_productions_path(@contract_production), :method => "post" do
