...
describe "contract_products/edit" do
  before(:each) do
  ...
  it "renders the edit contract_product form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => contract_products_path(@contract_product), :method => "post" do
