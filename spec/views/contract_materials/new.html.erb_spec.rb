...
describe "contract_materials/new" do
  before(:each) do
    assign(:contract_material, stub_model(ContractMaterial,
      :contract_id => 1,
      :code => "MyString",
      :plus_code => "MyString",
      :name => "MyString",
  ...
  it "renders new contract_material form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => contract_materials_path, :method => "post" do
