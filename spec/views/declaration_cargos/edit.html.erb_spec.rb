...
describe "declaration_cargos/edit" do
  before(:each) do
  ...
  it "renders the edit declaration_cargo form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => declaration_cargos_path(@declaration_cargo), :method => "post" do
