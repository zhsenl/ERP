...
describe "foreign_enterprises/new" do
  before(:each) do
    assign(:foreign_enterprise, stub_model(ForeignEnterprise,
      :code => "MyString",
      :name => "MyString",
      :address => "MyString",
      :linkman => "MyString",
  ...
  it "renders new foreign_enterprise form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => foreign_enterprises_path, :method => "post" do
